...
async function ClientDashboardPage() {
    ...
    if (!tenantSubdomainFromHeader) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('/select-tenant?error=tenant_ctx_missing_client_dash');
    }
    let tenant = null;
    try {
        console.log(`[CLIENT_DASHBOARD] Attempting to find tenant with subdomain: '${tenantSubdomainFromHeader}'`);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"] && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].tenant) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`/select-tenant?error=db_error_client_dash&attempted=${tenantSubdomainFromHeader}`);
    }
    if (!tenant) {
        console.error(`[CLIENT_DASHBOARD] Tenant with subdomain '${tenantSubdomainFromHeader}' not found post-query. Redirecting.`);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`/select-tenant?error=tenant_not_found_client_dash&attempted=${tenantSubdomainFromHeader}`);
    }
    if (tenant.tenant_type !== 'client_org') {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`/select-tenant?error=incorrect_type_client_dash&type=${tenant.tenant_type}`);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e2d7539._.js.map